...
export default function ContactSection() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const publicKey = process.env.NEXT_PUBLIC_EMAILJS_PUBLIC_KEY || "JTS2DsfV8D3mHylVd";
    const serviceId = process.env.NEXT_PUBLIC_EMAILJS_SERVICE_ID || "service_2l65nuq";
    const templateId = process.env.NEXT_PUBLIC_EMAILJS_TEMPLATE_ID || "template_c61fszo";
